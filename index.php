                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('alert_b', 2); ?></span> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contacts__map">
                            <?php echo do_shortcode ( '[yamap center="'. get_field('first_coor') . ',' . get_field('second_coor') . '" height="100%" controls="" zoom="14" type="yandex#map" mobiledrag="0" coord="'. get_field('first_coor') . ',' . get_field('second_coor') . '"][/yamap]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="163" title="Форма отзывов"]') ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
